...
/**
 * Defines a class to build a listing of Link list entities.
 *
 * @ingroup oe_link_lists
 */
class LinkListListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new LinkListListBuilder object.
   *
